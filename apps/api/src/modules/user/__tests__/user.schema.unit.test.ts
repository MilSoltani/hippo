...
import { CreateUserSchema, publicColumns, UpdateUserSchema, UserSchema } from '../user.schema'
...
describe('userSchema', () => {
  describe('insert validation', () => {
    ...
    it('rejects password in insert', () => {
      ...
      const result = CreateUserSchema.safeParse(USER_1)
  ...
  describe('public shape', () => {
    ...
    it('rejects password in select', () => {
      ...
      const result = UserSchema.safeParse(USER_1)
